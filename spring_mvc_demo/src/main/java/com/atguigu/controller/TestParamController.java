 ...
 * 3、@RequestParam：将请求参数username和控制器方法的形参username绑定 ，
 * 即index路径里的请求参数username和这里value绑定username的属性名字不一致的情况，用@RequestParam设置
...
public class TestParamController {
    ...
    public String getParamByServletAPI(HttpServletRequest request){
        //设置request编码之前一定不要获取任何请求参数，比如request.xx，否则失效
    ...
    public String getParamByPojo(User user){//通过实体类的形参User获取
